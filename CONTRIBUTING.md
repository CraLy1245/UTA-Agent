...
UTA Agent 是一个采用 MIT 许可证的开源实验项目，目前处于 `0.1.0-alpha`，且维护者资源有限。欢迎其他开发者协助维护和验证：可提交可复现的问题报告、小范围修复、测试改进、文档修正，也欢迎通过 Issue 提出尚不成熟但值得讨论的想法。
...
本项目使用 MIT 许可证。提交贡献前，请确认你有权提供相关内容；维护者合并贡献不改变项目许可证，也不代表对第三方内容授予额外权利。
